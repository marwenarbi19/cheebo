...
const AdminReports = () => {
  const [reports, setReports] = useState([
    ...
    },
    {
      ...
      type: 'message',
      contentId: 123,
      contentTitle: 'Message privé harcelant',
      contentAuthor: 'Harasser123',
      reportedBy: 'Victim User',
      reporterEmail: 'victim@email.com',
      reason: 'Harcèlement',
      description: 'Messages répétés et menaçants envoyés en privé.',
  ...
  const handleBulkAction = (action) => {
    ...
    switch (action) {
      ...
      case 'dismiss':
        ...
        break;
      default:
        break; // Do nothing for unrecognized actions
    }
    setSelectedReports([]);
  };
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-[#8657ff] text-white p-6">
        ...
        <nav className="space-y-4">
          ...
          <Link to="/admin/reports" className="block text-yellow-300 font-semibold">
            ⚠️ Signalements
          </Link>
